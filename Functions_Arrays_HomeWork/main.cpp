...
double Array_Math_Operator(double arr[], const int ARR_LENGTH, string switcher = "sum")
{
	if (switcher == "sum")
	{
		double sum = 0;
...
void Array_Shifter(double arr[], const int ARR_LENGTH, int shift_number, int switcher = 0)
{
	int shift;
